      ...
      >
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          ...
          <p className="mt-2 text-xs text-justify text-gray-400">
           Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima nemo illo dicta et molestiae tempora autem odit vero commodi. Quia voluptate ipsam amet officia sunt. Sint vitae magni quaerat accusamus.
          </p>
